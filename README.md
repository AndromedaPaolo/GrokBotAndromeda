...
Parti da `docs/Fantasy_Empire_Proposta_Commerciale.md` (v2.4).
...
| `docs/Fantasy_Empire_Decisioni_Aperte.md` | Menu da confermare (1–20) |
...
| `docs/Fantasy_Empire_Video_Storage_Generazione.md` | Grok Imagine, MP4 su R2, quota settimanale, niente chiavi dei giocatori |
