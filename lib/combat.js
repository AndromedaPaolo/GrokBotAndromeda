...
/**
 * % di applicare status/drain (non il danno, non Bound).
...
/** Bound (salta il turno): solo Bond, di rado, e Unique, sempre. Tutte le altre categorie: 0. */
...
export const EFFECT_COPY = {
  dazed: {
    ...
    doesIt: "agiscono per ultimi nel turno",
  },
  wound: {
    name: "Wound",
    doesEn: "they take +1 damage from every hit",
    doesIt: "subiscono +1 danno da ogni colpo",
  },
  blind: {
    name: "Blind",
    doesEn: "their next action misses",
    doesIt: "la loro prossima azione manca",
  },
  bound: {
    name: "Bound",
    doesEn: "they skip their next turn",
    doesIt: "saltano il prossimo turno",
  },
};
...
/** Chi deve ancora giocare: l'attore attuale, oppure il prossimo in lista. */
