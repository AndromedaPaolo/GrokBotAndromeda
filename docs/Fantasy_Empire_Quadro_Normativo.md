...
**Riferimenti:** `Fantasy_Empire_Proposta_Commerciale.md` · `Fantasy_Empire_Video_IA_Azioni.md` · `Fantasy_Empire_Grok_Bot_Ops.md`
**Versione:** 1.0 — 28 agosto 2026
**Oggetto:** tutte le norme che l'idea descritta nei tre file deve rispettare per esistere legalmente.
**Ipotesi di base:** titolare stabilito in Italia, vendita a consumatori (B2C), gioco web, stack GitHub · Vercel · Cloudflare D1/R2 · Stripe, video generati da IA con tono "SFW sexy", bot ops post-profitto.
...
| 10 | "Zero costo fisso di infrastruttura" **non** significa zero costo di conformità | Tutto il resto di questo file | Classificazione, testi legali, eventuale age assurance, ADR, commercialista: sono costi di Fase A, non di Fase C |
...
Va aggiunto al piano di lavoro come attività di Fase A: la classificazione descrive anche gli "acquisti nel videogioco", quindi va rifatta se cambiano gli SKU.
...
### Fase A — prima di rendere Stripe live

Blocchi che impediscono il lancio se mancanti:
...
- [ ] Classificazione per età ottenuta (PEGI o IARC) e pittogrammi esposti (§7.6)
- [ ] Age gate 18+ coerente con classificazione e T&C
- [ ] T&C / EULA, privacy policy, cookie policy, refund policy, policy contenuti e moderazione
...
- [ ] Dati art. 7 D.lgs. 70/2003 nel footer; nessun riferimento alla piattaforma ODR; organismo ADR indicato
- [ ] Registro dei trattamenti, DPA con Vercel/Cloudflare/Stripe/provider IA, verifica DPF
- [ ] Valutazione preliminare DPIA verbalizzata
- [ ] Procedura data breach (72 ore) scritta
- [ ] Punto di contatto DSA pubblicato e comunicato
- [ ] Pipeline di moderazione dei video con coda `banned`, revisione umana e log
- [ ] Verifica contrattuale della marcatura AI Act art. 50 da parte del provider video
- [ ] Verifica marchio e dominio; inventario licenze (font, audio, open source)
- [ ] Piano fiscale: registro dei corrispettivi, prova di localizzazione del cliente, monitoraggio soglia 10.000 €
- [ ] Decisione sui territori di vendita (UE / UK / USA) alla luce di §7.2

### Fase B — prime vendite
