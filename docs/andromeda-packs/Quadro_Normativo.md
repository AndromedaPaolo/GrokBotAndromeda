# Quadro normativo — Andromeda Packs

**Tipo documento:** mappa operativa per copy, pack e (un giorno) vendita. Non è un parere legale.
**Versione:** 1.0 — 30 agosto 2026
**Chi approfondisce:** G2 Gazzetta, con fonti e data. C5 Verbale scrive nel repo solo dopo il tuo Approva.

Due umani restano sopra: tu, e avvocato/commercialista quando i testi o il fisco sono veri.

---

## 1. Cosa stiamo vendendo (quando si venderà)
...
## 2. Professioni intellettuali — L. 132/2025

Art. 13 (sintesi da fonti pubbliche, da rifare con Gazzetta il giorno della vendita):

- L'IA nelle professioni intellettuali è **strumentale e di supporto**.
- Prevale il lavoro intellettuale della prestazione.
...
Trasparenza se l'utente interagisce con un sistema di IA. Un catalogo che vende file è un conto. Una demo live in cui il visitatore parla con un agente è un altro: lì serve dire che è un agente.

Scoring CV / assunzione: rischio alto. Pack `recruiter-screening` resta in coda finché Gazzetta non scrive i paletti.

---

## 4. GDPR

Memoria di laboratorio: dati finti. Vietato copiare inbox vere in `memory/SEED.md`.
...
## 6. Claim pubblicitari

Vietato: risultati di sostituzione occupazionale non misurati, "l'unica IA approvata", loghi ISTAT/Agenzia Entrate a caso, "conforme L. 132" come certificazione.

Consentito: numero di compiti mappati, numero dimostrati in eval, link allo scenario, data dell'eval, versione pack.

---

## 7. Checklist prima di `in-vendita` (box, non date)
...
Verbale (C5) tiene questa lista nel repo. Non la mette verde perché è settembre.
