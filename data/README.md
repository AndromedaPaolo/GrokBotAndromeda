...
The first Tentacle monster has 5 Normal cards (`tentacle_lash`, `tentacle_coil`, `tentacle_slam`, `tentacle_grasp`, `tentacle_ink`) and 1 Origin: `tentacle_birth` (Birth card, `kind: monster_origin`, grows +1 SP). Card art shows the action or the summon, not a girl. Combat `public.video` is a 16:9 clip of that attack on Selene (SFW sexy, invented adult 27). Miss = 2D art.
